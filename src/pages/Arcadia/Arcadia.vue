<template>
  <div>
    <iframe
      ...
      width="100%"
      :src="
        `/Game/Arcadia/?worldManager=${getWorldManager}&landMap=${getLandMap}&treasureHunt=${getTreasureHunt}&treasureHuntId=${getTreasureHuntId}&expectedVersion=1.1.2.7&baseUrl=${getBaseUrl}`
      "
      frameborder="0"
      scrolling="no"
    ></iframe>
