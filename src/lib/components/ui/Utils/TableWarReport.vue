<template>
  <v-card width="100%">
    ...
    >
      ...
      <template v-slot:[`item.wCOURAGEAmount`]="{ item }">
        <amount
          :amount="item.wCOURAGEAmount"
          formatted
          decimals="5"
          compact
          approximate
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Corporation Power", value: "powerTeamA" },
        { text: "Degenerate Power", value: "powerTeamB" },
        { text: "Team", value: "team" },
        { text: "wCOURAGE", value: "wCOURAGEAmount" },
