  ...
  >
    <v-row dense>
      <v-col dense cols="12" md="12">
        <div
          class="d-flex flex-column flex-md-row justify-space-between align-center you-will-need py-2"
        >
          <div class="d-flex align-center px-1 font-weight-black">
            You need at least 10 wLAND to provide liquidity for this reward
          </div>
        </div>
        ...
        >
          <div class="d-flex justify-center align-center mr-3">
            ...
            <number-field
              ...
              dense
              :min="min"
              @change="this.$emit('tokenAmountA', tokenAmountA)"
            ></number-field>
          </div>
        ...
        <div class="mt-2">
          <div class="mt-1">
            ...
            <span class="primary--text font-weight-bold ">
              16.836 wLAND/BUSD Pool Tokens</span
            >
          </div>
          <div class="mt-1">
            <span class=" font-weight-bold">Share of Pool: </span>
            <span class="primary--text font-weight-bold "> 0.1225%</span>
          </div>
        </div>
        ...
        <!-- <div class="d-flex justify-center align-center">
          ...
          >
            <template v-slot:label>
              <div class="my-1">
                I understand that the withdrawal of workers can reduce my
                production time for new workers
              </div>
            </template>
          </v-checkbox>
        </div> -->
