...
import { getGoldSavers } from "./Collectibles/GoldSavers";
...
export function getCollectibles() {
  ...
  return [].concat(getGameItems(), getLegendaryRelics(), getWeapons(), getMagicalItems(), getFoundations(), getGoldSavers());
}
